...
\section{Why is a security policy needed?} % Explaining the need for a security policy, can be quite general.
...
%        \item Password is expected to be during an even of security breach.
