...
%\todo{The network security policy plays a central role for the company as it helps MjosTaxis protect their information system assets and processes.}

%The network policy is set to establish administrative direction, requirements and guidance to ensure the protection of MjøsTaxis information hosted in their network.
...
%\todo{perhaps you can rename this to "Security Awareness Training"....Do you differentiate between security awareness and other type of certification/training in this section e.g. CISCO, Linux etc...?}
